...
BrowserStartPromise.then(function(browserObj){
    ...
    let EnteringEmailPromise = page.type("[placeholder='Your username or email']", EmialPassobj.Emial, {delay: 50} );
    ...
    let PressEnterPromise = page.click("[class='ui-btn ui-btn-large ui-btn-primary auth-button ui-btn-styled']", {delay: 100});
    ...
    let SelectingProblemPromise = page.$$("[class='ui-btn ui-btn-normal primary-cta ui-btn-line-primary ui-btn-styled']",{delay: 100});
